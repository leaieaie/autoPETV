...
\author{Naoki Haku}
\authorrunning{N. Haku}
\institute{School of Health Sciences, Faculty of Medicine,
...
Table~\ref{tab:lb} lists the submissions we made with models we trained
ourselves and with the official weights. The official baseline, shown for
reference, was not beaten by any of them. Our final submission, a ten-fold
ensemble of the public LesionLocator weights, scored higher on the preliminary
set than the six-fold variant listed here; we do not read anything further into
that difference, for the reason given in Section~\ref{sec:discussion}.
